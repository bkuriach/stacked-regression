...
test = pd.read_csv("./Regression/test.csv")
...
print(rmsle(y_train,stacked_train_pred*0.7 + lgb_train_pred*0.30 ))
...
print('RMSLE score on train data:')
print(rmsle(y_train,stacked_train_pred*Stacked + xgb_train_pred*XGBoost+ lgb_train_pred*LGBM))
